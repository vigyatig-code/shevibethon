...
// Layout: wraps the entire app with the Civic Galaxy theme.
// The animated background and scroll progress only appear on
// the home page to keep other routes lightweight. Navigation
// is sticky and becomes more opaque on scroll. Mobile menu
// uses an accessible hamburger toggle.
