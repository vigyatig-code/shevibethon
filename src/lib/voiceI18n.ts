...
export const PROMPTS: Record<Language, PromptMap> = {
  en: {
    ...
    heardInvalidSpell: `Would you like to spell it out instead? Just say "spell it", or try saying it again.`,
  ...
  hi: {
    ...
    heardInvalidSpell: 'क्या आप इसे एक-एक करके बताना चाहेंगे? "स्पेल करें" बोलिए, या फिर से बोलिए।',
